...
export const Profile: React.FC = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 animate-fade-in-up">
      <h1 className="text-3xl font-serif text-charcoal">Profile</h1>

      {/* User Info */}
      <div className="bg-white border border-charcoal/5 rounded-xl p-6 space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <div className="text-sm text-charcoal/50">Display Name</div>
            <div className="text-lg font-medium text-charcoal">{displayName || 'Anonymous'}</div>
          </div>
          <div className="text-right">
            <div className="text-sm text-charcoal/50">Credit Balance</div>
      ...
      <div className="bg-white border border-charcoal/5 rounded-xl p-6 space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-serif text-charcoal">Invite Friends</h2>
        </div>
        <p className="text-sm text-charcoal/60">
          Share your referral link. You earn 10% of every credit your invitees spend on analysis.
        </p>
            ...
            {referralInfo && (
              <div className="grid grid-cols-2 gap-4 pt-2">
                <div className="bg-warm-white rounded-lg px-4 py-3">
                  <div className="text-xs text-charcoal/50">Friends Invited</div>
                  <div className="text-xl font-mono font-semibold text-charcoal">{referralInfo.invitedCount}</div>
                </div>
                <div className="bg-warm-white rounded-lg px-4 py-3">
                  <div className="text-xs text-charcoal/50">Total Commission</div>
      ...
      <div className="bg-white border border-charcoal/5 rounded-xl p-6 space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-serif text-charcoal">Credit History</h2>
        </div>
        ...
        {loading ? (
          ...
          <p className="text-sm text-charcoal/40 py-4 text-center">No transactions yet</p>
        ) : (

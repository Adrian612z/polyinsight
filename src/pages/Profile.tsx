...
import { CalendarCheck2, Check, Coins, Copy, Flame, Gift, History, Sparkles, Users } from 'lucide-react'
...
export const Profile: React.FC = () => {
  ...
  const { displayName, creditBalance, referralCode, privyUserId, setCreditBalance } = useAuthStore()
